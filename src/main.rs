...
async fn main() {
    ...
    let app = route("/todos", get(todos_index).post(todos_create))
        ...
        .route("/todos1/:id", patch(todos_update).delete(todos_delete))
        .route("/todos2/:id", patch(todos_update).delete(todos_delete))
        .route("/todos3/:id", patch(todos_update).delete(todos_delete))
        .route("/todos4/:id", patch(todos_update).delete(todos_delete))
        .route("/todos5/:id", patch(todos_update).delete(todos_delete))
        .route("/todos6/:id", patch(todos_update).delete(todos_delete))
